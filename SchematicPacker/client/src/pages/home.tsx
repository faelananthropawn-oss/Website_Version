        ...
        {stats && (
          <div className="flex justify-center mt-8 px-4">
            <div className="flex gap-6 text-sm text-gray-400">
              <span data-testid="stat-visits">{stats.visits.toLocaleString()} site visits</span>
              <span>•</span>
              <span data-testid="stat-packs">{stats.packsCreated.toLocaleString()} packs created</span>
              <span>•</span>
              <span data-testid="stat-downloads">{stats.downloads.toLocaleString()} downloads</span>
            </div>
          </div>
        )}
      </div>
